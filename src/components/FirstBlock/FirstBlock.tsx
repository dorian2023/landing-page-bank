        ...
        <div className="relative p-4 md:py-40">
            ...
            <div className="grid max-w-5xl mx-auto md:grid-cols-2">
                <div>
                    ...
                    <Reveal>
                        <p className="max-w-md mt-10">Nuestro equipo de expertos utiliza una metodología para identificar los muebles que probablemente se ajusten a sus necesidades. Examinamos calidad, diseño, y precios competitivos</p>
                    </Reveal>
                    <Reveal>
                        <div className="my-8">
